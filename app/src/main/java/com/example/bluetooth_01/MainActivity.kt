...
class  MainActivity : AppCompatActivity() {
    ...
    private fun setUpButtons() {
        ...
        val flashButton = findViewById<Button>(R.id.button_flash)
        flashButton?.setOnClickListener {
            theMessage = "flash"
            mTextarea!!.append("Message has been updated to flash")
        }
        val beepButton = findViewById<Button>(R.id.button_beep)
        beepButton?.setOnClickListener {
            theMessage = "beep"
            mTextarea!!.append("Message has been updated to beep")
        }
        val shakeButton = findViewById<Button>(R.id.button_shake)
